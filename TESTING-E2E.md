# MCP Screenshot E2E Testing

This document describes the end-to-end testing strategy for the MCP Screenshot server and VSCode extension.

## Test Files

### 1. `server.e2e.spec.ts` - Comprehensive E2E Tests
Full end-to-end tests that exercise the MCP Screenshot server through the stdio protocol, similar to how real clients would interact with it.
...
3. Use Command Palette to test commands:
   ...
   - `MCP Screenshot: Capture Window`
   - `MCP Screenshot: Capture Region`
   - `MCP Screenshot: List Displays`
   - `MCP Screenshot: List Windows`
